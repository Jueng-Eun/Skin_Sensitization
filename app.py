...
st.title("피부감작성(GHS) 예측기")

mw = st.number_input("MW (분자량) (g/mol)", min_value=0.0, value=200.0)
mp = st.number_input("MP (녹는점) (°C)", min_value=-100.0, value=50.0)
st_val = st.number_input("ST (표면장력) (dyn/cm)", min_value=0.0, value=20.0)
